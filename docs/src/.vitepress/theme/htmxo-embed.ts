...
//
// Snapshot source: HTMXObjects/assets/vitepress/htmxo-embed.ts at 017e5b7.
// Re-sync this file and its companion CSS locally when upstream changes;
// docs builds deliberately carry no HTMXObjects dependency.
